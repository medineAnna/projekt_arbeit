...
public class C01 {
	...
	public class Bakkal {
		private int ortalamaKazanc;
		private int ortUstKazancGun;
		private int ortAltKazancGun;

		public int getOrtalamaKazanc() {
			return ortalamaKazanc;
		}

		public int getOrtUstKazancGun() {
			return ortUstKazancGun;
		}

		public int getOrtAltKazancGun() {
			return ortAltKazancGun;
		}
